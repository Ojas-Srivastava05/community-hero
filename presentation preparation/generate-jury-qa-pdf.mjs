...
h2:first-of-type { page-break-before: avoid; margin-top: 14px; }
...
await page.pdf({
  ...
  footerTemplate:
    '<div style="width:100%;font-size:7.5px;text-align:center;color:#888;padding:0 12mm;">Community Hero · Jury Q&A STAR Guide · <span class="pageNumber"></span> / <span class="totalPages"></span></div>',
})
await browser.close()
